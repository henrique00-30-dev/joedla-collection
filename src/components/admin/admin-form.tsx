...
export function AdminSwitchField({
  ...
  return (
    <View
      style={[
        styles.switchField,
        disabled && styles.switchFieldDisabled,
        style,
      ]}>
      ...
      {icon ? (
        <View
          ...
          <Ionicons
            name={icon}
            size={18}
            color={selected ? colors.white : '#9D5F1D'}
          />
        </View>
      ) : null}
...
export function AdminFormActions({
  ...
  return (
    <View style={[styles.formActions, style]}>
      {children}
    </View>
  );
}
