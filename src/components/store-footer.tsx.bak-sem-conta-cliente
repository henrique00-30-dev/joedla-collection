    ...
    <View style={styles.footer}>
      <View style={styles.newsletterArea}>
        <View
          ...
          <View style={styles.newsletterCopy}>
            <Text style={styles.newsletterEyebrow}>
              JOEDLA COLLECTION
            </Text>

            <Text style={styles.newsletterTitle}>
              Atendimento próximo, moda escolhida com cuidado.
            </Text>

            <Text style={styles.newsletterText}>
              Fale com a loja, tire dúvidas e receba atendimento
      ...
      <View
        ...
        <View style={styles.brandColumn}>
          ...
          <Text style={styles.tagline}>
            Moda e acessórios selecionados para valorizar cada
            momento.
          </Text>
      ...
      <View style={styles.bottom}>
        <Text style={styles.copyright}>
          © {new Date().getFullYear()} Joedla Collection
        </Text>
